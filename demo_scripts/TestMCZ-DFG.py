...
settings["global"]["time_series_delta_t"] = 50
...
for job in jobman.finished:
    for i in range(25,35):
        ...
        dfgjob = DFG4GRN()
        dfgjob.setup(timeseries_storage, TFList(timeseries_storage[0].gene_list), settings, "MCZ-DFG_Test_Top_{0}_Edges".format(i), 20, None, job.alg.network)
        jobman.queueJob(dfgjob)
